        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}>
              ...
              {/* Professional badge */}
              <div className="inline-flex items-center bg-white border border-slate-200 px-4 py-2 rounded-sm mb-8 shadow-sm">
              ...
              <h1 className="text-4xl lg:text-5xl font-light text-slate-900 mb-4 leading-tight">
                Giriraj Mani
                <br />
                <span className="font-normal text-slate-700">Pokharel</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                className="bg-slate-800 hover:bg-slate-900 text-white px-8 py-3 font-medium tracking-wide flex items-center justify-center gap-2 transition-all duration-200 shadow-sm hover:shadow-md">
                  Learn More
                  <ArrowRight size={16} />
                </button>
                <button className="border border-slate-300 text-slate-700 hover:bg-slate-100 px-8 py-3 font-medium tracking-wide transition-all duration-200">
                  GET INVOLVED
                </button>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-slate-100 -z-10"></div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-slate-200 -z-10"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="experience" className="relative py-20 bg-white">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className={`text-center mb-16 transform transition-all duration-1000 ${experienceVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="inline-flex items-center bg-slate-50 border border-slate-200 px-4 py-2 rounded-sm mb-6">
              <Shield className="w-4 h-4 text-slate-600 mr-2" />
              <span className="text-slate-700 font-medium text-sm tracking-wide">EXPERIENCE & LEADERSHIP</span>
            </div>
            
            <h2 className="text-3xl lg:text-4xl font-light text-slate-900 mb-6">
              A Legacy of 
              <span className="font-normal text-slate-700 ml-2">Public Service</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {experiences.map((experience, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-slate-50 p-8 h-full hover:shadow-lg transition-all duration-300 border border-slate-100">
          ...
          <div className={`mt-16 bg-slate-800 p-8 lg:p-12 transform transition-all duration-1000 delay-500 ${experienceVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="max-w-4xl mx-auto text-center">
              <h3 className="text-2xl font-light text-white mb-6">
                Political Journey & 
                <span className="font-normal text-slate-300 ml-2">Party Leadership</span>
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-slate-400 tracking-wide uppercase">First Ministerial Appointment</div>
                </div>
                <div>
                  <div className="text-3xl font-light text-white mb-2">2008</div>
                  <div className="text-sm text-slate-400 tracking-wide uppercase">Constituent Assembly Election</div>
                </div>
                <div>
                  <div className="text-3xl font-light text-white mb-2">2009</div>
                  <div className="text-sm text-slate-400 tracking-wide uppercase">Party Unification Leadership</div>
                </div>
              </div>
            </div>
          </div>
