        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 lg:px-8">
          <div className={`text-center transform transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center bg-slate-50 border border-slate-200 px-4 py-2 rounded-sm mb-8">
              ...
              <span className="text-slate-700 font-medium text-sm tracking-wide">GET IN TOUCH</span>
            </div>
            ...
            <h1 className="text-4xl lg:text-5xl font-light text-slate-900 mb-6 leading-tight">
              Contact &
              <br />
              <span className="font-normal text-slate-700">Connect</span>
            </h1>
      ...
      <section className="py-20 bg-slate-50">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className={`text-center mb-16 transform transition-all duration-1000 ${
            ...
            <h2 className="text-2xl lg:text-3xl font-light text-slate-900 mb-6">
              Contact 
              <span className="font-normal text-slate-700 ml-2">Information</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white p-6 border border-slate-200 hover:shadow-lg transition-all duration-300 h-full">
                    
                    {/* Icon */}
                    <div className="bg-slate-100 p-3 w-fit mb-4">
            ...
            <div className={`transform transition-all duration-1000 delay-300 ${
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl lg:text-3xl font-light text-slate-900">
                  Send a 
                  <span className="font-normal text-slate-700 ml-2">Message</span>
                </h2>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-12 pr-4 py-3 border border-slate-300 bg-white text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full px-4 py-3 border border-slate-300 bg-white text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows="6"
                      className="w-full px-4 py-3 border border-slate-300 bg-white text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent resize-vertical"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-slate-800 hover:bg-slate-900 text-white px-8 py-3 font-medium tracking-wide flex items-center justify-center gap-2 transition-all duration-200"
                  >
                    Send Message
                    <Send size={16} />
                  </button>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
          <div className={`text-center transform transition-all duration-1000 delay-700 ${
            ...
            <h3 className="text-2xl lg:text-3xl font-light text-white mb-6">
              Visit Our 
              <span className="font-normal text-slate-300 ml-2">Office</span>
            </h3>
            
            <div className="w-16 h-0.5 bg-slate-400 mx-auto mb-8"></div>
            
            <p className="text-slate-300 leading-relaxed text-lg mb-12 max-w-2xl mx-auto">
              Our office is located in the heart of Kathmandu. We welcome scheduled visits 
              and meetings during our regular office hours.
            </p>

            {/* Map placeholder */}
            <div className="bg-slate-700 border border-slate-600 h-64 flex items-center justify-center mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <div className="text-sm text-slate-400 tracking-wide uppercase">Location</div>
              </div>
              <div>
                <div className="text-2xl font-light text-white mb-2">Accessible</div>
                <div className="text-sm text-slate-400 tracking-wide uppercase">By Public Transport</div>
              </div>
              <div>
                <div className="text-2xl font-light text-white mb-2">Parking</div>
                <div className="text-sm text-slate-400 tracking-wide uppercase">Available</div>
              </div>
            </div>
          </div>
        </div>
